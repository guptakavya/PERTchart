...
int lenCriticalPath=0;
     ...
     */
    void addEdge(Vertex from, Vertex to, int weight) { //addEdge to add a new edge to the graph 
	Edge e = new Edge(from, to, weight); //weight taken defualt as 1
	if(this.directed) {
	    from.adj.add(e);
            to.revAdj.add(e);
	} else {
